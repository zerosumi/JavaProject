...
public class FontAttrDialog extends JDialog {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 250265731349891817L;
	...
	protected InputList fontNameList = new InputList(fontNames, "Name:");
	protected InputList fontSizeList = new InputList(fontSizes, "Size:");
	public static String[] fontNames;
	public static String[] fontSizes;
	
	private static final String PREVIEW_TEXT = "Preview";

	public FontAttrDialog(JFrame owner) {
		super(owner, "FontAttr", false);
		...
		p.add(fontNameList);
		fontNameList.setDisplayedMnemonic('n');
		fontNameList.setToolTipText("Font name");

		p.add(fontSizeList);
		fontSizeList.setDisplayedMnemonic('s');
		fontSizeList.setToolTipText("Font size");
		getContentPane().add(p);

		p = new JPanel(new GridLayout(2, 3, 10, 5));
		p.setBorder(new TitledBorder(new EtchedBorder(), "Attr"));
		...
		p.setBorder(new TitledBorder(new EtchedBorder(), "Preview s"));
		...
		fontNameList.addListSelectionListener(listSelectListener);
		fontSizeList.addListSelectionListener(listSelectListener);
	...
	public void setAttributes(AttributeSet a) {
		...
		fontNameList.setSelected(name);
		int size = StyleConstants.getFontSize(a);
		fontSizeList.setSelectedInt(size);
	...
	public AttributeSet getAttributes() {
		...
		StyleConstants.setFontFamily(attributes,
				fontNameList.getSelected());
		StyleConstants.setFontSize(attributes,
				fontSizeList.getSelectedInt());
		...
		StyleConstants.setStrikeThrough(attributes,
	...
	protected void updatePreview() {
		...
		String name = fontNameList.getSelected();
		int size = fontSizeList.getSelectedInt();
		if (size <= 0)
			return;
	...
	public static void main(String argv[]) {
		...
		FontAttrDialog dlg = new FontAttrDialog(new JFrame());
...
class InputList extends JPanel implements ListSelectionListener, ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -707901932569628163L;
	...
	class OpelListLabel extends JLabel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -5122669705860929646L;
	...
	class OpelListText extends JTextField {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 6663399273582854026L;
	...
	class OpelListList extends JList {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -2864567999960758117L;
	...
	protected class AccessibleOpenList extends AccessibleJComponent {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -3064258730887771073L;
...
class FontLabel extends JLabel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3765114756292906565L;
...
class ColorComboBox extends JComboBox {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7550206054131281958L;
	...
	class ColorComboRenderer1 extends JPanel implements ListCellRenderer {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -4009118395337278382L;
